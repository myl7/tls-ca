...
openssl genpkey -algorithm ec -pkeyopt ec_paramgen_curve:P-256 > ../ca-priv/myl7_org.key
...
'
openssl x509 -req -in myl7_org.csr -CA ca.pem -CAkey ../ca-priv/ca.key -days 3650 -copy_extensions copy > myl7_org.pem
